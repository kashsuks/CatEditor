...
impl ThemeColors {
    pub fn from_lua_theme(lua: &crate::config::theme_manager::ThemeColors) -> Self {
        ...
        let _teal_c = p(&lua.teal);
        let _sky_c = p(&lua.sky);
        let _pink_c = p(&lua.pink);
...
fn pinel_blueberry_dark() -> ThemeColors {
    ...
    let _red = Color::from_rgb(0.875, 0.271, 0.463); // #df4576
...
fn pinel_blueberry_light() -> ThemeColors {
    ...
    let _red = Color::from_rgb(0.824, 0.059, 0.224); // #d20f39
...
fn github_dark() -> ThemeColors {
    ...
    let _yellow = Color::from_rgb(0.882, 0.776, 0.369); // #e3b341 approx
...
fn nord() -> ThemeColors {
    ...
    let _aurora_r = Color::from_rgb(0.749, 0.380, 0.416); // #bf616a
    let aurora_o = Color::from_rgb(0.816, 0.529, 0.439); // #d08770
    let _aurora_y = Color::from_rgb(0.922, 0.796, 0.545); // #ebcb8b
...
fn tokyonight() -> ThemeColors {
    ...
    let _green = Color::from_rgb(0.451, 0.839, 0.506); // #73daca approx 9ece6a
    ...
    let _yellow = Color::from_rgb(0.878, 0.769, 0.459); // #e0af68
