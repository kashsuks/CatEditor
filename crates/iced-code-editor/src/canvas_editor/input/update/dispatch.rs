...
impl CodeEditor {
    ...
    pub fn update(&mut self, message: &Message) -> Task<Message> {
        ...
        match message {
            ...
            Message::OpenCommandPalette => self.handle_open_command_palette_msg(),
            Message::CloseCommandPalette => self.handle_close_command_palette_msg(),
            Message::CommandPaletteChanged(query) => self.handle_command_palette_changed_msg(query),
            ...
            Message::SubmitCommandPalette => self.handle_submit_command_palette_msg(),
            ...
            Message::SearchDialogShiftTab => self.handle_search_dialog_tab(false),
